  ...
  <div class="fs-header__top">
    <div class="fs-header__top-inner">
      ...
      <div class="fs-header__right">
        <button class="fs-theme-toggle" id="fs-theme-toggle" aria-label="Alternar tema claro/escuro">
...
<?php if (!is_front_page() && !is_archive() && !is_home() && !is_attachment() && !is_singular(['post', 'golpe', 'fraude', 'glossario'])): ?>
